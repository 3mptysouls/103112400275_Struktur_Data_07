...
Parent Node 1 -> Child Node A -> Child Node B
Parent Node 2 -> Child Node C
```
...
```text
Isi list induk: 10 20 30
Isi list induk 1: 100 200
Isi list induk 2: 300
Jumlah elemen dalam list induk: 3
Setelah menghapus semua elemen, apakah list induk kosong? Ya
```
