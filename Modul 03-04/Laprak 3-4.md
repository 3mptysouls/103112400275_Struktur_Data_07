...
```text
D:\Tugas\SEM3\StrukturData\Praktikum\modul3-4\guided>.\main.exe
input nama = dafa
input nilai1 = 67
input nilai2 = 41
rata - rata = 54
...
Pilih: 1
Masukkan nama: Dafa
Masukkan pesanan: Mocha
Antrian dengan nama Dafa berhasil ditambahkan.
...
0. Exit
Pilih: 2
Antrian dengan nama Nasihuy telah dilayani.
