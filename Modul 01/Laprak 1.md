...
```text
Masukkan sebuah karakter: cihuyy
...
```text
(tempel Screenshot output guided 5 di sini)
```
...
```text
Masukkan Nama Mahasiswa: Dafa 
Masukkan NIM Mahasiswa : 103112400275
Masukkan IPK Mahasiswa : 3.2
